...
CCP_CLOUD_PASSPHRASE, CCP_CLOUD_NEW_PASSPHRASE y CCP_CLOUD_RECOVERY dan los secretos sin preguntarlos.`,
	...
	"cli.cloud.push_pin_failed": {
		En: "Pinning not synced (%s): %s. The snapshots were uploaded; run `ccp cloud push` again.",
		Es: "No se pudo poner al día lo fijado (%s): %s. Los snapshots sí subieron; repite `ccp cloud push`.",
	},
